...
class User(Base):
    ...
    teams = relationship(
        ...
        secondaryjoin="and_(team_member.c.team_id == Team.id, Team.deleted_at == None)",
...
class Team(Base):
    ...
    members = relationship(
        "User",
        secondary="team_member",
        secondaryjoin="and_(team_member.c.user_id == User.id, User.deleted_at == None)",
...
class TeamMember(Base):
    ...
    user_id = Column(
        "user_id", UUID, ForeignKey("user.id", ondelete="CASCADE"), nullable=False
    )
